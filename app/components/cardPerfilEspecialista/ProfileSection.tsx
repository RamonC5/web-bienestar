        ...
        <section className="py-16 bg-gradient-to-r from-indigo-50 to-indigo-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              {/* Sección "Sobre mí" */}
              <div>
                <h2 className="text-4xl font-extrabold text-gray-500 mb-4">Conoce a Dr. Maria Gómez</h2>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-semibold text-gray-500 mb-4">Experiencia y Logros</h3>
                <ul className="list-none space-y-4">
                  <li className="flex items-start">
                    <AcademicCapIcon className="h-6 w-6 text-gray-500 flex-shrink-0 mr-3" />
